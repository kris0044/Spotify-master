...
const PUBLIC_ARTIST_DIRECTORY_SEARCHES = {
	global: {
		week: ["top artists this week", "weekly music chart", "viral artists this week"],
		month: ["top artists this month", "monthly music chart", "best artists this month"],
	},
	regional: {
		week: ["top artists this week india", "india weekly music chart", "viral artists in india this week"],
		month: ["top artists this month india", "india monthly music chart", "best artists in india this month"],
	},
} as const;
...
export const fetchPublicArtistDirectory = async (): Promise<PublicArtistDirectoryResponse> => {
	const [globalChart, regionalChart, globalWeekResults, globalMonthResults, regionalWeekResults, regionalMonthResults] = await Promise.allSettled([
		fetchPublicMusicCharts("global"),
